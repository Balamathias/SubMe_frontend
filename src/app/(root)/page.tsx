    ...
    <main className="text-white bg-gradient-to-r from-slate-900 via-purple-900 to-slate-900 bg-blend-overlay min-h-screen relative" >
      ...
      <section className="flex gap-3 w-full max-md:flex-col-reverse p-4 lg:p-8 justify-between  max-w-7xl mx-auto items-stretch mt-20">
        <div className="flex-1 flex flex-col space-y-6 h-full">
          ...
          <div className="flex gap-3 flex-row items-center max-sm:flex-col">
            <Link 
              className="p-4 text-center flex items-center justify-center rounded-xl border-2 bg-clip-border text-clip bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-green-600 via-amber-600 to-fuchsia-900 mt-3 font-semibold hover:opacity-50 hover:transition-all"
              href={'/'}>Get Started with Email</Link>
            <Link 
              className="p-4 text-center flex items-center justify-center border-gray-500 rounded-xl border-2 bg-clip-text text-transparent text-clip bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-green-600 via-amber-600 to-fuchsia-900 mt-3 font-semibold hover:opacity-50 hover:transition-all"
              href={'/'}>Continue with Google</Link>
          </div>
