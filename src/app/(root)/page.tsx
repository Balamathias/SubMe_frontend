  ...
  return (
    <WidthWrapper className="min-h-screen justify-center items-center" >
      <div className="flex flex-col gap-3 p-6 lg:px-10 lg:py-10 rounded-lg">
        ...
        <h1 className="text-3xl py-2.5 text-primary">Welcome to SubME, Your ultimate Aitime and data Top-up platform!</h1>

        <p className="text-muted-foreground">Top up Data and Airtime at Cheaper Rates at<b className="text-brand font-semibold">Subme!</b>.</p>
