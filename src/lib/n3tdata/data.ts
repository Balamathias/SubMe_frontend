type DataPlan = {
  ...
  export const dataPlans: DataPlan[] = [
    ...
    { id: 5, provider: 'MTN', category: 'SME', dataAmount: '5GB', price: '₦1,300.00', duration: '1 Month' },
    { id: 6, provider: 'MTN', category: 'SME', dataAmount: '10GB', price: '₦2,600.00', duration: '1 Month' },
    ...
    { id: 22, provider: 'GLO', category: 'GIFTING', dataAmount: '4.1GB', price: '₦1,450.00', duration: '1 Month' },
    { id: 24, provider: 'GLO', category: 'GIFTING', dataAmount: '5.8GB', price: '₦1,900.00', duration: '1 Month' },
    { id: 36, provider: '9MOBILE', category: 'GIFTING', dataAmount: '1.5GB', price: '₦950.00', duration: '1 Month' },
    { id: 37, provider: '9MOBILE', category: 'GIFTING', dataAmount: '2GB', price: '₦1,100.00', duration: '1 Month' },
    { id: 38, provider: '9MOBILE', category: 'GIFTING', dataAmount: '3GB', price: '₦1,400.00', duration: '1 Month' },
    { id: 39, provider: '9MOBILE', category: 'GIFTING', dataAmount: '4.5GB', price: '₦1,800.00', duration: '1 Month' },
    ...
    { id: 49, provider: 'AIRTEL', category: 'COOPERATE GIFTING', dataAmount: '5GB', price: '₦1,400.00', duration: '1 Month' },
    ...
    { id: 54, provider: 'MTN', category: 'COOPERATE GIFTING', dataAmount: '5GB', price: '₦1,300.00', duration: '1 Month' },
    { id: 55, provider: 'MTN', category: 'COOPERATE GIFTING', dataAmount: '10GB', price: '₦2,600.00', duration: '1 Month' },
    { id: 56, provider: 'AIRTEL', category: 'COOPERATE GIFTING', dataAmount: '10GB', price: '₦2,800.00', duration: '1 Month' },
  ...
  { id: 62, provider: 'GLO', category: 'COOPERATE GIFTING', dataAmount: '5GB', price: '₦1,250.00', duration: '1 Month' },
  { id: 63, provider: 'GLO', category: 'COOPERATE GIFTING', dataAmount: '10GB', price: '₦2,500.00', duration: '1 Month' },
  ...
  { id: 76, provider: '9MOBILE', category: 'COOPERATE GIFTING', dataAmount: '5GB', price: '₦1,000.00', duration: '1 Month' },
  { id: 77, provider: '9MOBILE', category: 'COOPERATE GIFTING', dataAmount: '10GB', price: '₦2,000.00', duration: '1 Month' }
  ];
